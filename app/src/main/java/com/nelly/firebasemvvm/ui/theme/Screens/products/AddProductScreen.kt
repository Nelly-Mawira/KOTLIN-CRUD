package com.nelly.firebasemvvm.ui.theme.Screens.products
...
import com.nelly.firebasemvvm.data.productviewmodel
...
fun ImagePicker(modifier: Modifier = Modifier, context: Context, navController: NavHostController, name:String, quantity:String, price:String) {
    ...
    Column(modifier = modifier,) {
        if (hasImage && imageUri != null) {
            ...
            Image(bitmap = bitmap.asImageBitmap(), contentDescription = "Selected image", modifier = Modifier
                .size(100.dp,200.dp)
                .padding())
        }
        Column(
            modifier = Modifier.fillMaxWidth().padding(bottom = 20.dp), horizontalAlignment = Alignment.CenterHorizontally,) {
            Button(
                onClick = {
